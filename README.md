...
Développement d'une application de visite virtuelle d'un jardin fruitier avec le logiciel Unity.
L'objectif est de créer ce jardin au milieu d'une île avec modélisation du terrain et de l'environnement.
